...
class MapperTest {
    ...
    void testMapStringToType_string() {
        Optional<?> result = Mapper.mapStringToType("\"hello\"", String.class);
    ...
    void testMapStringToType_integer() {
        Optional<?> result = Mapper.mapStringToType("123", Integer.class);
        assertTrue(result.isPresent());
    ...
    void testMapStringToType_long() {
        Optional<?> result = Mapper.mapStringToType("123456789", Long.class);
        assertTrue(result.isPresent());
    ...
    void testMapStringToType_double() {
        Optional<?> result = Mapper.mapStringToType("123.45", Double.class);
        assertTrue(result.isPresent());
    ...
    void testMapStringToType_bigInteger() {
        Optional<?> result = Mapper.mapStringToType("123456789012345678", BigInteger.class);
        assertTrue(result.isPresent());
    ...
    void testMapStringToType_bigDecimal() {
        Optional<?> result = Mapper.mapStringToType("12345.6789", BigDecimal.class);
        assertTrue(result.isPresent());
    ...
    void testMapStringToType_boolean() {
        Optional<?> result = Mapper.mapStringToType("true", Boolean.class);
        assertTrue(result.isPresent());
    ...
    void testMapStringToType_localDate() {
        Optional<?> result = Mapper.mapStringToType("\"2023-12-25\"", LocalDate.class);
        assertTrue(result.isPresent());
    ...
    void testMapStringToType_localDateTime() {
        Optional<?> result = Mapper.mapStringToType("\"2023-12-25T15:30:00\"", LocalDateTime.class);
        assertTrue(result.isPresent());
    ...
    void testMapStringToType_date() {
        Optional<?> result = Mapper.mapStringToType("\"2023-12-25T15:30:00.000Z\"", Date.class);
        assertTrue(result.isPresent());
    ...
    void testMapStringToType_empty() {
        Optional<?> result = Mapper.mapStringToType("unsupported", Void.class);
